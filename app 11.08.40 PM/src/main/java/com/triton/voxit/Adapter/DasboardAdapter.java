...
import com.triton.voxit.model.ImageConverter;
...
public class DasboardAdapter extends RecyclerView.Adapter<DasboardAdapter.FoodItemHolder> {
...
//    List<RecyclerViewItem> recyclerViewItems;
    ...
    public DasboardAdapter(ArrayList<TrendingResponseBean> recyclerViewItems, Context mContext, Dashboard activity) {
